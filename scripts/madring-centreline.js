...
// Regenerate: node scripts/madring-from-geojson.js <path-to-f1-circuits>
//
...
// Projected to a local metric plane, confirmed clockwise, scaled so the
// circuit's tightest pinch (58.6 m, under La Monumental) stays wider than
// the road, and resampled at even arc length.
//
//   world      : 1334 x 2033 px
//   scale      : 1.0244 px/m
//   lap        : 5547 px = 5415 m

const MADRING_WORLD = { W: 1334, H: 2033, scale: 1.024386, lapM: 5414.8 };
const MADRING_CP = [
